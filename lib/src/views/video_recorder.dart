                              ...
                              child: Center(
                                child: Container(
                                  child: Center(
                                    child: AspectRatio(
                                        aspectRatio:
                                            localVideoController!.value.size !=
                                                    null
                  ...
                  (_con.showProgressBar)
                      ? Positioned(
                          ...
                          child: ValueListenableBuilder(
                              ...
                              builder:
                                  (context, double videoProgressPercent, _) {
        ...
        child: CameraPreview(
          ...
          child: LayoutBuilder(
            ...
            return GestureDetector(
              ...
              onTapDown: (details) =>
                  _con.onViewFinderTap(details, constraints),
            );
          }),
        ),
      );
        ...
        ? !cameraController.value.isRecordingVideo && !_con.isProcessing
            ...
            : AnimatedBuilder(
                ...
                builder: (context, child) => SizedBox.fromSize(
                  size:
                      Size(_con.sizeAnimation.value, _con.sizeAnimation.value),
                  // button width and height
                  child: GestureDetector(
                    onTap: () {
                      setState(() {});
