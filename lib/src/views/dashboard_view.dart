      ...
      if (videoRepo.homeCon.value.videoControllers2.length > 0) {
        videoRepo.homeCon.value.videoControllers2.forEach((key, value) async {
          ...
          videoRepo.homeCon.value.videoControllers2.remove(
              videoRepo.followingUsersVideoData.value.videos.elementAt(count1));
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (!_con.showFollowingPage.value) {
                                        _con
                                            .videoController(_con.swiperIndex)
                                            .pause();
                                      } else {
                                        _con
                                            .videoController2(_con.swiperIndex2)
                                            .pause();
                                      }
                                      if (currentUser.value.token != '') {
                                        Navigator.pushReplacementNamed(
                    ...
                    TabItem(
                      icon: IconButton(
                        ...
                        onPressed: () async {
                          ...
                          videoRepo.isOnHomePage.notifyListeners();
                          if (!_con.showFollowingPage.value) {
                            if (_con.videoController(_con.swiperIndex) !=
                                null) {
                              _con.videoController(_con.swiperIndex).pause();
                            }
                          } else {
                            if (_con.videoController2(_con.swiperIndex2) !=
                                null) {
                          ...
                          if (!videoRepo
                            ...
                            if (videoRepo.homeCon.value.videoController2(
                                    videoRepo.homeCon.value.swiperIndex2) !=
                                null) {
                              if (videoRepo.homeCon.value.videoController(
                                      videoRepo.homeCon.value.swiperIndex2) !=
                          ...
                          return IconButton(
                            ...
                            onPressed: () async {
                              if (!homeLoader) {
                                ...
                                videoRepo.homeCon.value.userVideoObj.value
                                    .userId = 0;
                                videoRepo.homeCon.value.userVideoObj.value
                                    .videoId = 0;
                                videoRepo
                                    .homeCon.value.userVideoObj.value.name = "";
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap: () {
                                                                      ...
                                                                      if (!videoRepo
                                                                          ...
                                                                          .showFollowingPage
                                                                          .value) {
                                                                        if (videoRepo.homeCon.value.videoController(videoRepo.homeCon.value.swiperIndex) !=
                                                                            null) {
                                                                          videoRepo
                                                                              .homeCon
                                                                              .value
                                                                        ...
                                                                        if (videoRepo.homeCon.value.videoController(videoRepo.homeCon.value.swiperIndex2) !=
                                                                            null) {
                                                                          videoRepo
                                                                              .homeCon
                                                                              .value
                                                                                          ...
                                                                                          child: PopupMenuButton<int>(
                                                                                              ...
                                                                                              onSelected: (int) {
                                                                                                if (int == 0) {
                                                                                                  ...
                                                                                                  _con.showDeleteAlert(context, "Delete Confirmation", "Do you realy want to delete this comment", videoRepo.homeCon.value.comments.elementAt(i).commentId, videoObj!.videoId);
                                                                                                }
                                                                                              },
                                                                                              itemBuilder: (context) {
